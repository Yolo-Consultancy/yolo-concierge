...
export function ContactModal({
  ...
  return (
    ...
    >
      <div
        className="bg-charbon border border-white/10 rounded-2xl w-full max-w-xl my-8 transition-transform duration-300 scale-100"
        ...
        <div className="p-6 text-white">
          {submitted ? (
            <div className="text-center py-10">
              <div className="w-16 h-16 mx-auto rounded-full bg-or-vif/10 flex items-center justify-center mb-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {prefilledVehicle && (
                <div className="flex items-center gap-3 p-3 rounded-xl border border-or-vif/30 bg-or-vif/5 text-sm text-or-vif">
              ...
              <div className="pt-4 border-t border-white/10 flex gap-3">
                ...
                <button
                  type="submit"
                  className="flex-1 py-3.5 rounded-xl bg-or-vif text-black text-sm font-medium hover:bg-white transition flex items-center justify-center gap-2"
                >
