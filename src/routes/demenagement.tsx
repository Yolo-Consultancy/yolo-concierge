    ...
    <main className="min-h-screen bg-background">
      ...
      <section id="services" className="mx-auto max-w-7xl px-6 py-20">
        ...
        <div id="processus" className="mt-16 rounded-2xl bg-primary text-primary-foreground p-10 md:p-14 text-center">
          ...
          <Link
            to="/contact"
            search={{ portal: "demenagement" }}
            className="inline-flex items-center gap-2 bg-gold text-gold-foreground px-7 py-3 rounded-md font-medium hover:opacity-90 transition"
          >
            Obtenir un devis
