...
function VehicleDetail() {
  ...
  return (
    <div className="bg-charbon text-white min-h-screen font-sans">
      <header className="fixed top-0 inset-x-0 z-50 border-b border-white/10 bg-charbon/95 backdrop-blur-md">
        <div className="mx-auto max-w-7xl flex items-center justify-between px-4 py-3 md:px-6 md:py-4">
      ...
      <div className="mx-auto max-w-7xl px-6 py-10 pt-[5.5rem]">
